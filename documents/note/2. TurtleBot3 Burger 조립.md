...
[https://www.youtube.com/watch?v=5D9S_tcenL4](https://www.youtube.com/watch?v=5D9S_tcenL4)

## Raspberry Pi install

[https://emanual.robotis.com/docs/en/platform/turtlebot3/sbc_setup/](https://emanual.robotis.com/docs/en/platform/turtlebot3/sbc_setup/)
...
sudo apt update && sudo apt inros2 run turtlebot3_teleop teleop_keyboardstall locales

sudo locale-gen en_US en_US.UTF-8

sudo update-locale LC_ALL=en_US.UTF-8 LANG=elinear_acceleration_covariance:
- 0.0
- 0.0
- 0.0
- 0.0
...
[https://www.youtube.com/watch?v=UqYR_z3q9a0](https://www.youtube.com/watch?v=UqYR_z3q9a0)
